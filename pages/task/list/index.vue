<template>
  <div class="wrapper">
    <div class="content-header">
      <el-button class="el-icon-circle-plus-outline" @click="addTask"
        >添加任务</el-button
      >
    </div>
      ...
      <el-collapse v-model="activeNames" @change="handleChange">
        ...
        >
          ...
          >
            ...
            <el-table-column prop="site_task_name" label="任务名称" width="120">
            </el-table-column>
            <el-table-column prop="site_task_desc" label="任务描述" width="400">
            </el-table-column>
            <el-table-column label="任务进度" width="120">
              <template slot-scope="scope">
                <span style="margin-left: 10px">{{
                  processStatus[scope.row.site_task_progress]
                }}</span>
              </template>
            </el-table-column>
            <el-table-column fixed="right" label="操作" width="150">
              <template slot-scope="scope">
                <el-button type="text" size="small" @click="selectBy(scope.row)"
                  >编辑</el-button
                >
                <el-button type="text" size="small" @click="deleteBy(scope.row)"
                  >删除</el-button
                >
              </template>
            </el-table-column>
...
<script>
import DetailPopBox from "../components/DetailPop";
import AddPopBox from "../components/AddPop";
